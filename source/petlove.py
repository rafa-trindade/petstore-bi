        ...
        okr_data = [
            {
                ...
                "Observação": "% Cidades > 250 mil Habitantes com Petlove presente" if cidade_sel == "Todas" else "Selecione uma Região ou Estado"
            },
            {
                "OKR": "OKR2",
                ...
                "Meta": f"100%" if cidade_sel == "Todas" else "-",
                "Observação": f"% Capitais regionais com Petlove presente" if cidade_sel == "Todas" else "Selecione uma Região ou Estado"
            },
            {
                "OKR": "OKR3",
                ...
                "Observação": f"Qtd. Cidades >100 mil Habitantes com presença exclusiva da Petlove" if cidade_sel == "Todas" else "Selecione uma Região ou Estado"
            },
