...
def grafico_concorrencia_mini(df, empresa_sel, empresas_disponiveis):
    ...
    if empresa_sel != "Todas":
        df_grafico = df_grafico[df_grafico["empresa_clean"].str.lower().isin(["cobasi", empresa_sel.lower()])]
