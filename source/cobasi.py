...
def cobasi_analysis():
    ...
    if df_filtrado_tab1.empty:
        ...
        # HHI
        df_okr7 = kpi.hhi_regiao(df_cobasi_filtrado, df_filtrado_tab1)
        ...
        okr_data = [
            {
                ...
                "Observação": "Considera apenas cidades com Cobasi presente"
            },
            {
                "OKR": "OKR2",
                ...
                "Atual": f"",
                "Meta": "100%",
                "Observação": f"Considera apenas cidades com Cobasi presente"
            },
            {
                "OKR": "OKR3",
